...
- **`trace_id` everywhere.** Surface the Ferro trace ID anywhere the framework exposes response metadata. This is the join key for the observability bridge plugins.
